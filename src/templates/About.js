...
const Product = ({ pageContext }) => (
 <StaticQuery
    ...
    render={data=> <div>    
      <Header />
      <Img fluid={data.placeholderImage.childImageSharp.fluid} style={{height:500}} />
       ...
       <div className="row bg-white  pt-5 ">
                ...
                <div className="row bg-white mb-5">
                    <div className="col-md-6 col-sm-8">
                        <div className="custom-header h-space-3">
                            <div className="custom-header--bold">Our Story</div>
                        </div>

                        <p className="text-container_body-text">
                        We are a bunch of wonderful IT talents who cooperate to reliably deliver top-notch software solutions. We owe our
                        triumph to our dynamic culture that is rooted in self-organization. We are unique because we follow the customer-first
                        approach.
                        </p>
                    ...
                    <div className="col-md-6 col-sm-4"><img src="./img/about_nunc/img-1.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="row bg-white">
            <div className="col-md-8 offset-md-2 mb-3 mt-3">
                <div className="row ">
                    <div className="col-md-6 col-sm-4"><img src="./img/about_nunc/img-2.png" alt="" />
                    </div>
                    <div className="col-md-6 col-sm-8">
                        <div className="custom-header h-space-3">
